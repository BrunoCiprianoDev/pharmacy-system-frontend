export const parametrosVendas = [
    ...
    { id: 4, atributo: 'total', rotulo: 'Total', tipo: 'text', toFixed: true, before: "R$",  fixed: true },
]
...
export const parametroItemsVenda = [
    ...
    { id: 3, atributo: 'sellPrice', rotulo: 'Preço', tipo: 'text', before: "R$",  toFixed: true,  fixed: true },
    { id: 4, atributo: 'units', rotulo: 'Unidades', tipo: 'text' },
    { id: 5, atributo: 'totalItem', rotulo: 'Total item', tipo: 'text', before: "R$", fixed: true },
]