...
export const parametrosCompras = [
  ...
  { id: 2, atributo: 'total', rotulo: 'Total', tipo: 'number', placeholder: 'R$9999.99', before: "R$" },
  ...
  { id: 4, atributo: 'noteNumber', rotulo: 'Nota fiscal', tipo: 'text', placeholder: '999.999.999-99', tipo: 'textMask', mask: "999.999.999-99"  } 
]
