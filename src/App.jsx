    ...
    <BrowserRouter basename="/pharmacy-system-frontend">
      <Routes>
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioUsuario />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaFuncionarios />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheFuncionarios />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioFuncionarios />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaDescontos />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheDescontos />} />
            ) : (
              <Navigate to="/" />
            )
          }
        />
        <Route
          path="/descontos/form/:id"
          element={
            auth ? (
              <MainLayout children={<FormularioDescontos />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaMercadorias />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheMercadorias />} />
            ) : (
              <Navigate to="/" />
            )
          }
        />
        <Route
          path="/mercadorias/form/:id"
          element={
            auth ? (
              <MainLayout children={<FormularioMercadorias />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaFornecedores />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheFornecedores />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioFornecedores />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaCompras />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheCompras />} />
            ) : (
              <Navigate to="/" />
            )
          }
        />
        <Route
          path="/compras/form/:id"
          element={
            auth ? (
              <MainLayout children={<FormularioCompras />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaLotes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheLotes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioLotes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaPerdas />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalhePerdas />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioPerdas />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaDevolucoes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheDevolucoes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        />
        <Route
          path="/devolucoes/form/:id"
          element={
            auth ? (
              <MainLayout children={<FormularioDevolucoes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<ListaClientes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheClientes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<FormularioClientes />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          path="/novaVenda/"
          element={
            auth ? <MainLayout children={<NovaVenda />} /> : <Navigate to="/" />
          }
        />
        <Route
          path="/vendas/"
          element={
            auth ? (
              <MainLayout children={<ListaVenda />} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          ...
          element={
            auth ? (
              <MainLayout children={<DetalheVenda />} />
            ) : (
              <Navigate to="/" />
            )
          }
